...
class Pn532_i2c:
    ...
    def read_response(self):
        ...
        while True:
            ...
            try:
                ...
                sleep(DEFAULT_DELAY)
                self.PN532.read(response) #Cambiado mraa se supone que esto lee del bus y lo mete en response
    ...
    def send_command(self, frame):
        ...
        while True:
            try:
                ...
                sleep(DEFAULT_DELAY)
                self.PN532.write(frame.to_tuple) #Cambiado a mraa se supone que escribe varios bytes al bus
    ...
    def reset_i2c(self):
        ...
        #self.PN532.close() #No hay close en mraa
        del self.PN532
        self.PN532 = mraa.I2c(self.i2c_channel)
        self.PN532.address(self.address)
